...
// VALIDATE CUSTOMER
 ...
 // Validates Personal Info
   $(document).on("click", ".submit", function () { 
        ...
        alert('  Password must be Between 8 to 15 characters. Accept Only letter, digits & underscore and first character must be a letter.')  ;
        return false;  
        } 
        if (document.personal.conditionterms.checked == false)
        {
        alert ('Please Agree With Terms & Conditions Thank You');
        return false;
        }
