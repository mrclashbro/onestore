                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a>OneStore Inc</a></p>
                        </div>
                    </div> 
                  </div>
                                     ...
                                     <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                          <p>Note</p>
                                            Password must be Between 8 to 15 characters. Accept Only letter, digits & underscore and first character must be a letter.
                                         </div> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  ><b>TERMS AND CONDITION</b></a> of OneStore Inc.</small>
