...
<head>
  ...
  <link href="css/responsive.css" rel="stylesheet">
    ...
    <![endif]-->       
    <link rel="icon" href="images/ico/favicon-32x32.png" type="image/png" />
</head><!--/head-->
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="tel:+94-76-653-4085"><i class="fa fa-phone"></i>+94-76-653-4085</a></li>
                <li><a href="mailto:30014295@student.toiohomai.ac.nz"><i class="fa fa-envelope"></i>30014295@student.toiohomai.ac.nz</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>One</span>Store</h2>
              <p>Through listening to our customers, Bidfood has identified opportunities for value-add light processing and bespoke manufacture to make our customers' lives easier.</p>
            </div>
                                      </div>
          <div class="col-sm-3">
            <div class="address">
              <img src="images/home/map.png" alt="Colombo" />
              <p align="center">Colombo Srilanka</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Developed by <span>Avishka Bandara</span></p>
          <p class="pull-right">Designed by <span>Navpreet Bal</span></p>
        </div>
      </div>
    </div>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/control.js"></script> 
 <script type="text/javascript">
